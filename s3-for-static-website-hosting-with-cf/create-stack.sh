...
aws cloudformation create-stack --stack-name $StackName --capabilities "CAPABILITY_NAMED_IAM" --region "us-west-2" --template-body file://template.json --parameters $params --profile personal --tags $tags
